...
import { fetchUserRequest, loginRequest, registerRequest } from '../../api/auth-services';
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View>
          ...
          />
          <ButtonPrimary onPress={handleSubmit(onSubmit)} title={'Register'} />
          <View style={{ alignItems: 'center', marginVertical: RFValue(20) }}>
            <ButtonText onPress={() => navigation.navigate({ name: 'Login' })}>
              <Text style={styles.new}>
                Been here before? <Text style={styles.signup}>Login</Text>
              </Text>
            </ButtonText>
          </View>
        </View>
