...
export default function Indicators(props) {
  ...
  return (
    <Modal
      {...indicatorState}
      isVisible={Boolean(indicatorState.isVisible && indicatorState.status)}
    ...
    >
      ...
      <View style={styles.content}>
        {indicatorState.status === indicatorActionTypes.Loading && (
          <View style={styles.wrapper}>
            {<Text style={styles.title}>{indicatorState.title}</Text>}
        ...
        {indicatorState.status === indicatorActionTypes.Error && (
          <View style={styles.wrapper}>
